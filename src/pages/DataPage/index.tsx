...
function DataPage() {
  ...
  return (
    <div className="my-5 mainContainer flex flex-column gap-3">
      <Card
        title={
          <div
          ...
          >
            <span style={{ fontSize: '1.2rem' }}>累计专注</span>
            <AimOutlined style={{ fontSize: '2rem' }} />
          </div>
        }
        action={<PieChartOutlined />}
      >
        <div className="flex flex-around flex-align-center">
      ...
      <Card
        title={
          ...
          >
            <span style={{ fontSize: '1.2rem' }}>今日专注</span>
            <DotChartOutlined style={{ fontSize: '2rem' }} />
          </div>
        }
